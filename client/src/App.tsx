      ...
      <header className="App-header">
        <Router>
          ...
          <Switch>
            ...
            <Route path="/Events">
              <img
                src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fstatic.doomworld.com%2Fmonthly_2019_05%2F4ezIzWF.jpg.f74e8b271cfff7beb39ae87c1a168e7f.jpg&f=1&nofb=1"
                className="App-logo"
                alt="logo"
              />
