...
const redux_group = (GROUP_state:string) =>{ return { type: 'GROUP', payload:GROUP_state } }
...
// REDUCER
const change_index = (state={index:0, relation:Relation.Manager, id:-1, members:null, group:-1}, action:any) =>{
        switch(action.type){
                case "INDEX":
