...
function EventsForm({ name, address, time, date, description, set_relation }: EventInfo) {
        const [displayRSVP, setIsRSVP] = React.useState(false);
        const [change, setChange] = React.useState(false);
        const _tmp = () => {console.log(store.getState()); setChange(!change)}
        const setRSVP = () => {
        ...
        React.useEffect(()=>{ store.subscribe(changeIndex) });
